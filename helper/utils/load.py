...
class Load(luigi.Task):
    def run(self):
        try:
            ...
            # Data to be loaded
            category = pd.read_csv(f'{EXTRACT_OUTPUT_DIR}category.csv')
            subcategory = pd.read_csv(f'{EXTRACT_OUTPUT_DIR}subcategory.csv')
            customer = pd.read_csv(f'{EXTRACT_OUTPUT_DIR}customer.csv')
            orders = pd.read_csv(f'{EXTRACT_OUTPUT_DIR}orders.csv')
            product = pd.read_csv(f'{EXTRACT_OUTPUT_DIR}product.csv')
            order_detail = pd.read_csv(f'{EXTRACT_OUTPUT_DIR}order_detail.csv')
